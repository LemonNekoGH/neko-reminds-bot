...
composer.Composer = void 0;
const context_1$3 = context$2;
function always$2(x) {
    return () => x;
}
const anoop$1 = always$2(Promise.resolve());
class Composer {
    constructor(...fns) {
    ...
    static fork(middleware) {
        ...
        return async (ctx, next) => {
            await Promise.all([handler(ctx, anoop$1), next()]);
        };
    }
    static tap(middleware) {
        const handler = Composer.unwrap(middleware);
        return (ctx, next) => Promise.resolve(handler(ctx, anoop$1)).then(() => next());
    }
    /**
    ...
    static filter(predicate) {
        return Composer.branch(predicate, Composer.passThru(), anoop$1);
    }
    /**
     * Generates middleware for dropping matching updates.
     */
    static drop(predicate) {
        return Composer.branch(predicate, anoop$1, Composer.passThru());
    }
    ...
    static compose(middlewares) {
        ...
        return (ctx, next) => {
            ...
            async function execute(i, context) {
                var _a;
                if (!(context instanceof context_1$3.default)) {
...
Object.defineProperty(compact, "__esModule", { value: true });
compact.compactOptions = void 0;
...
var bufferAlloc$1 = function alloc (size, fill, encoding) {
  if (typeof size !== 'number') {
    throw new TypeError('"size" argument must be a number')
  }
...
var crypto$2 = require$$0__default$1["default"];
var bufferAlloc = bufferAlloc$1;
 ...
 * @return {boolean}
 */
var safeCompare$1 = function safeCompare(a, b) {
    var strA = String(a);
    var strB = String(b);
...
var nativeTimingSafeEqual = function nativeTimingSafeEqual(a, b) {
    ...
    return crypto$2.timingSafeEqual(bufA, bufB) && aLen === bLen;
};


var safeCompare_1 = (
    typeof crypto$2.timingSafeEqual !== 'undefined' ?
        nativeTimingSafeEqual :
        safeCompare$1
);

Object.defineProperty(webhook, "__esModule", { value: true });
const debug_1$3 = src.exports;
const safeCompare = safeCompare_1;
const debug$4 = (0, debug_1$3.default)('telegraf:webhook');
function default_1(hookPath, updateHandler) {
    return async (req, res, next = () => {
        res.statusCode = 403;
        debug$4('Replying with status code', res.statusCode);
        return res.end();
    }) => {
        debug$4('Incoming request', req.method, req.url);
        ...
        try {
            ...
            res.writeHead(415);
            res.end();
            debug$4('Failed to parse request body:', error);
            return;
        }
        await updateHandler(update, res);
    };
}
webhook.default = default_1;
...
class Polling {
        ...
        do {
            try {
                ...
                if (err.name === 'FetchError' ||
                    (err instanceof error_1$1.TelegramError && err.code >= 500)) {
                    const retryAfter = (_b = (_a = err.parameters) === null || _a === void 0 ? void 0 : _a.retry_after) !== null && _b !== void 0 ? _b : 5;
                    debug$3('Failed to fetch updates, retrying after %ds.', retryAfter, err);
                    await wait(retryAfter * 1000);
                    continue;
                }
                if (err instanceof error_1$1.TelegramError &&
    ...
    async loop(handleUpdates) {
        ...
        try {
            ...
            debug$3('Long polling stopped');
            // prevent instance reuse
            this.stop();
            await this.syncUpdateOffset().catch(noop$1);
        }
    }
    stop() {
...
function fetch(url, opts) {
	...
	return new fetch.Promise(function (resolve, reject) {
		...
		const send = (options.protocol === 'https:' ? require$$2__default["default"] : http__default["default"]).request;
...
check.is2D = check.hasPropType = check.hasProp = void 0;
/**
...
var sandwichStream = /*#__PURE__*/Object.freeze({
	__proto__: null,
	'default': SandwichStream,
	SandwichStream: SandwichStream
});

var require$$2 = /*@__PURE__*/getAugmentedNamespace(sandwichStream);

Object.defineProperty(multipartStream, "__esModule", { value: true });
const stream = Stream__default["default"];
const check_1$2 = check;
const sandwich_stream_1 = require$$2;
const CRNL = '\r\n';
class MultipartStream extends sandwich_stream_1.default {
    ...
    static isStream(stream) {
        return (typeof stream === 'object' &&
            stream !== null &&
            (0, check_1$2.hasPropType)(stream, 'pipe', 'function'));
    }
}
multipartStream.default = MultipartStream;
...
const node_fetch_1 = require$$4;
const check_1$1 = check;
const compact_1$1 = compact;
const multipart_stream_1 = multipartStream;
const error_1 = error;
const url_1$2 = Url__default["default"];
// eslint-disable-next-line @typescript-eslint/no-var-requires
const debug$2 = src.exports('telegraf:client');
...
function includesMedia(payload) {
    return Object.values(payload).some((value) => {
        ...
        return (value &&
            typeof value === 'object' &&
            (((0, check_1$1.hasProp)(value, 'source') && value.source) ||
                ((0, check_1$1.hasProp)(value, 'url') && value.url) ||
                ((0, check_1$1.hasPropType)(value, 'media', 'object') &&
                    (((0, check_1$1.hasProp)(value.media, 'source') && value.media.source) ||
                        ((0, check_1$1.hasProp)(value.media, 'url') && value.media.url)))));
    });
}
...
async function buildFormDataConfig(payload, agent) {
    for (const field of FORM_DATA_JSON_FIELDS) {
        if ((0, check_1$1.hasProp)(payload, field) && typeof payload[field] !== 'string') {
            payload[field] = JSON.stringify(payload[field]);
        }
    }
    const boundary = crypto$1.randomBytes(32).toString('hex');
...
async function attachFormValue(form, id, value, agent) {
    ...
    if (id === 'thumb') {
        const attachmentId = crypto$1.randomBytes(16).toString('hex');
    ...
    if (value &&
        typeof value === 'object' &&
        (0, check_1$1.hasProp)(value, 'media') &&
        (0, check_1$1.hasProp)(value, 'type') &&
...
class ApiClient {
    constructor(token, options, response) {
        ...
        this.options = {
            ...DEFAULT_OPTIONS$1,
            ...(0, compact_1$1.compactOptions)(options),
        };
    ...
    async callApi(method, payload, { signal } = {}) {
        ...
        if (options.webhookReply &&
            ...
            debug$2('Call via webhook', method, payload);
            // @ts-expect-error
        ...
        debug$2('HTTP call', method, payload);
        const config = includesMedia(payload)
            ? await buildFormDataConfig({ method, ...payload }, options.attachmentAgent)
            : await buildJSONConfig(payload);
        const apiUrl = new url_1$2.URL(`./${options.apiMode}${token}/${method}`, options.apiRoot);
        ...
        if (!data.ok) {
            debug$2('API call failed', data);
            throw new error_1.default(data, { method, payload });
        }
        return data.result;
    }
}
client.default = ApiClient;

Object.defineProperty(telegram, "__esModule", { value: true });
telegram.Telegram = void 0;
const client_1 = client;
const path_1 = require$$3__default["default"];
const url_1$1 = Url__default["default"];
class Telegram extends client_1.default {
    ...
    async getFileLink(fileId) {
        ...
        if (fileId.file_path !== undefined && (0, path_1.isAbsolute)(fileId.file_path)) {
            const url = new url_1$1.URL(this.options.apiRoot);
            url.port = '';
            url.pathname = fileId.file_path;
            url.protocol = 'file:';
            return url;
        }
        return new url_1$1.URL(`./file/${this.options.apiMode}${this.token}/${fileId.file_path}`, this.options.apiRoot);
    }
    /**
...
Object.defineProperty(telegraf, "__esModule", { value: true });
telegraf.Telegraf = void 0;
const crypto = require$$0__default$1["default"];
const http = http__default["default"];
const https = require$$2__default["default"];
const util = require$$1__default["default"];
const composer_1$5 = composer;
const compact_1 = compact;
const context_1$2 = context$2;
const debug_1$1 = src.exports;
const webhook_1 = webhook;
const polling_1 = polling;
const p_timeout_1 = pTimeout$1.exports;
const telegram_1 = telegram;
const url_1 = Url__default["default"];
const debug$1 = (0, debug_1$1.default)('telegraf:main');
const DEFAULT_OPTIONS = {
    telegram: {},
    handlerTimeout: 90000,
    contextType: context_1$2.default,
};
function always(x) {
    return () => x;
}
...
class Telegraf extends composer_1$5.Composer {
    constructor(token, options) {
        ...
        debug$1('Created a `Telegraf` instance');
    }
    get token() {
    ...
    startWebhook(hookPath, tlsOptions, port, host, cb) {
        ...
        this.webhookServer.listen(port, host, () => {
            debug$1('Webhook listening on port: %s', port);
        });
        return this;
    }
    secretPathComponent() {
    ...
    async launch(config = {}) {
        ...
        if (!domain) {
            debug$1('Bot started with webhook');
            return;
        }
        ...
        debug$1(`Bot started with webhook @ https://${domain}`);
    }
    stop(reason = 'unspecified') {
        var _a, _b;
        debug$1('Stopping bot... Reason:', reason);
    ...
    async handleUpdate(update, webhookResponse) {
        var _a, _b;
        (_a = this.botInfo) !== null && _a !== void 0 ? _a : (this.botInfo = (debug$1('Update %d is waiting for `botInfo` to be initialized', update.update_id),
            await ((_b = this.botInfoCall) !== null && _b !== void 0 ? _b : (this.botInfoCall = this.telegram.getMe()))));
        debug$1('Processing update', update.update_id);
        ...
        try {
            ...
            debug$1('Finished processing update', update.update_id);
        }
    }
}
...
router.Router = void 0;
const composer_1$4 = composer;
class Router {
    constructor(routeFn, handlers = new Map()) {
        this.routeFn = routeFn;
        this.handlers = handlers;
        this.otherwiseHandler = composer_1$4.default.passThru();
    ...
    on(route, ...fns) {
        ...
        this.handlers.set(route, composer_1$4.default.compose(fns));
        return this;
    }
    otherwise(...fns) {
        if (fns.length === 0) {
        ...
        this.otherwiseHandler = composer_1$4.default.compose(fns);
        return this;
    }
    middleware() {
        return composer_1$4.default.lazy((ctx) => {
            var _a;
...
button.login = button.pay = button.game = button.switchToCurrentChat = button.switchToChat = button.callback = button.url = button.pollRequest = button.locationRequest = button.contactRequest = button.text = void 0;
...
markup.inlineKeyboard = markup.keyboard = markup.forceReply = markup.removeKeyboard = markup.button = markup.Markup = void 0;
const check_1 = check;
class Markup {
...
markup.removeKeyboard = removeKeyboard;
function forceReply() {
    return new Markup({ force_reply: true });
}
markup.forceReply = forceReply;
...
Object.defineProperty(deunionize$1, "__esModule", { value: true });
deunionize$1.deunionize = void 0;
/**
...
deunionize$1.deunionize = deunionize;

var session$1 = {};

Object.defineProperty(session$1, "__esModule", { value: true });
session$1.isSessionContext = session$1.MemorySessionStore = session$1.session = void 0;
/**
...
session$1.MemorySessionStore = MemorySessionStore;
function isSessionContext(ctx) {
    return 'session' in ctx;
}
session$1.isSessionContext = isSessionContext;
...
const composer_1$3 = composer;
const debug_1 = src.exports;
...
context$1.default = SceneContextScene;

Object.defineProperty(stage, "__esModule", { value: true });
stage.Stage = void 0;
const session_1 = session$1;
const context_1$1 = context$1;
const composer_1$2 = composer;
class Stage extends composer_1$2.Composer {
    ...
    middleware() {
        const handler = composer_1$2.Composer.compose([
            (ctx, next) => {
                const scenes = this.scenes;
                const scene = new context_1$1.default(ctx, scenes, this.options);
                ctx.scene = scene;
                return next();
            },
            super.middleware(),
            composer_1$2.Composer.lazy((ctx) => { var _a; return (_a = ctx.scene.current) !== null && _a !== void 0 ? _a : composer_1$2.Composer.passThru(); }),
        ]);
        return composer_1$2.Composer.optional(session_1.isSessionContext, handler);
    }
    static enter(...args) {
...
base.BaseScene = void 0;
const composer_1$1 = composer;
const { compose } = composer_1$1.default;
class BaseScene extends composer_1$1.default {
...
context.default = WizardContextWizard;

Object.defineProperty(wizard, "__esModule", { value: true });
wizard.WizardScene = void 0;
const base_1 = base;
const context_1 = context;
const composer_1 = composer;
...
wizard.WizardScene = WizardScene;
...
var name = "neko-time-to-drink-bot";
var version = "0.1.0";
var description = "A robot that will remind you to ____";
var main$1 = "index.js";
var repository = "https://github.com/LemonNekoGH/neko-time-to-drink-bot.git";
var author = "LemonNeko <chheese048@gmail.com>";
var license = "MIT";
var scripts = {
...
function main() {
    ...
    const bot = new lib$2.Telegraf(token);
